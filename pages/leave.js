// pages/api/leave/index.js // Note: Original file path comment might be slightly inaccurate, file is at pages/leave.js
import { AppDataSource } from "@/utils/db"; // Corrected path
import Leave from "@/entities/Leave"; // Corrected path
